...
<!-- Sidebar -->
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="view/src/img/usuarios/king.png" class="img-circle elevation-2" alt="User Image">
            </div>
        <div class="info">
        <a href="#" class="d-block"><?php echo ucfirst($_SESSION["nombre"]) . " " . ucfirst($_SESSION["apellido_paterno"]); ?></a>
